...
public class GptService {
  ...
  private static final String SYSTEM_PROMPT_FOR_REPORT = """
      ...
      10. **behavior 카드 작성 규칙 (중요)**
         - biases 필드에는 대화에서 발견된 **논리적 오류나 인지 편향**만 포함하라.
         - skills 필드에는 **대화 기술의 부족이나 문제점**만 포함하라.
           * 강점이나 긍정적인 측면은 절대 포함하지 마라.
           * 예: "경청 부족", "감정 조절 실패", "비난적 언어 사용" 같은 부정적 측면만
           * 잘못된 예: "공감 능력", "논리적 사고", "명확한 의사 표현" 같은 강점은 제외
         - 입력받은 rag_items의 label을 참고하여 해당하는 편향/오류/기술 부족만 포함하라.
